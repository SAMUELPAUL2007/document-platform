...
export const metadata: Metadata = {
  ...
  description:
    "Read the terms of service for using DocFlow's free online document tools.",
  alternates: {
      ...
      <div className="prose prose-gray max-w-none space-y-6 text-foreground">
        <section>
          ...
          <p className="text-muted-foreground">
            By accessing and using DocFlow, you agree to be bound by these Terms of Service.
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            DocFlow provides free online document tools including PDF conversion, editing,
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            You are responsible for the documents you process using DocFlow. You agree not
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            DocFlow and its original content, features, and functionality are owned by
            DocFlow and are protected by copyright, trademark, and other intellectual
            property laws.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            DocFlow is provided &quot;as is&quot; without warranties of any kind. We are not
